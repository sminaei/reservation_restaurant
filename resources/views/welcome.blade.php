<x-guest-layout>
    ...
    style="background-image: url('https://png.pngtree.com/background/20210711/original/pngtree-brown-cartoon-snack-gourmet-restaurant-tea-e-commerce-banner-picture-image_1094319.jpg')">
    <h1
      ...
      <span class="inline md:block">Welcome To Food Is Best Restaurant</span>
    </h1>
      ...
      <div class="flex flex-wrap items-center sm:-mx-3">
        ...
        <div class="w-full md:w-1/2">
          <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
            <img src="https://img.freepik.com/free-photo/side-view-male-chef-kitchen-preparing-vegetables_23-2148763178.jpg" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container items-center max-w-6xl px-4 px-10 mx-auto sm:px-20 md:px-32 lg:px-16">
      <div class="flex flex-wrap items-center -mx-3">
        ...
        <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img
            ...
            src="https://u7.uidownload.com/vector/242/451/vector-chef-illustration-vectors-eps.jpg" alt="feature image"></div>
      </div>
    </div>
  </section>
