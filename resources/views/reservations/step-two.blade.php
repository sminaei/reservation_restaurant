<x-guest-layout>
    <div class="container w-full px-5 py-6 mx-auto">
        ...
        <div class="w-full bg-neutral-200 dark:bg-neutral-600">
            <div
              class=" w-100 p-1 text-xs front-medium leading-none text-center text-blue-100 bg-lue-100 bg-blue-600 rounded-full">
              step 2
            </div>
          </div>
   <form method="POST" action="{{ route('reservations.store.step.two') }}" enctype = "multipart/form-data">
                ...
                <div class="mt-6 p-4 flex justify-between">
                    <a href="{{ route('reservations.step.one') }}"
                        class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg">Previous
                    </a>
                <button type="submit"
                 class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg">Make Reservation</button>
                </div>
            </form>
